...
emailInput.addEventListener("input", (0, _lodashThrottleDefault.default)(saveDataToLocalStorage, 500));
messageInput.addEventListener("input", (0, _lodashThrottleDefault.default)(saveDataToLocalStorage, 500));
