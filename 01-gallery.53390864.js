...
const galleryMarkup = (0, _galleryItemsJs.galleryItems).map(({ preview , original , description  })=>`<li class="gallery__item">
...
gallery.addEventListener("click", (event)=>{
    ...
    if (event.target.classList.contains("gallery__image")) lightbox.open();
});
